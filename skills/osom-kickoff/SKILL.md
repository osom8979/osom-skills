...
[A] 풀 스코프
    설명: ...
    역할: supabase-schema, hono-worker, react-component-builder, react-page-builder
    Phase 1: supabase-schema + shadcn-manager
    Phase 2: hono-worker + react-component-builder
    Phase 3: react-page-builder
    예상 변경: ~15 파일

[B] MVP
    설명: ...
    역할: react-component-builder, react-page-builder
    Phase 1: react-component-builder
    Phase 2: react-page-builder
    예상 변경: ~5 파일
...
`/react-review` 스킬을 호출합니다. 코드 스타일, 필수 동반 파일, 빌드, 테스트, 보안, 문서 동기화를 검증합니다.
...
리뷰에서 실패 항목이 있으면 수정 후 커밋, 다시 `/react-review`를 실행합니다.
